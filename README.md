...
## Environments
- Preview: https://main--aem-edge-universal-editor--kalra-smriti.aem.page/
- Live: https://main--aem-edge-universal-editor--kalra-smriti.aem.live/
...
1. Open the `aem-edge-universal-editor` directory in your favorite IDE and start coding :)
